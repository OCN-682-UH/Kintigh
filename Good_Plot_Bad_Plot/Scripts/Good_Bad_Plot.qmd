---
title: "Good Plot / Bad Plot — Scooby-Doo Edition"
...
1.  Create a **clear, accurate, and visually effective** plot (“Good Plot”), and
2.  Create a **terrible, misleading, and painful** plot (“Bad Plot”), both using the same underlying data.
